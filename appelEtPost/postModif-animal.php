...
if (isset($_POST["submit"]) && isset($_SESSION['check']) && $_SESSION['check'] == "log") {
    ...
    if (isset($_POST["animal_name"]) && isset($_POST["animal_type"]) && isset($_POST["animal_mfi"]) && isset($_POST["animal_birthdate"]) && isset($_POST["animal_description"]) && !empty($_POST["animal_name"]) && !empty($_POST["animal_type"]) && !empty($_POST["animal_mfi"]) && !empty($_POST["animal_birthdate"]) && !empty($_POST["animal_description"]) && !empty($_POST["submit"])) {
        ...
        $stmt = "UPDATE animals SET animals.name = '$animal_name', animals.animal_type = '$animal_type', animals.mfi = '$animal_mfi', animals.birthdate = '$animal_birthdate', animals.description = '$animal_description'";
