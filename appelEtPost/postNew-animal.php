...
if (isset($_POST["submit"]) && isset($_SESSION['check']) && $_SESSION['check'] == "log") {
    ...
    if (isset($_POST["animal_name"]) && isset($_POST["animal_type"]) && isset($_POST["animal_mfi"]) && isset($_POST["animal_birthdate"]) && isset($_POST["animal_description"]) && isset($_FILES["animal_picture"]["name"]) && !empty($_POST["animal_name"]) && !empty($_POST["animal_type"]) && !empty($_POST["animal_mfi"]) && !empty($_POST["animal_birthdate"]) && !empty($_POST["animal_description"]) && !empty($_FILES["animal_picture"]["name"])) {
        ...
        $animal_name = htmlspecialchars(remove_emoji($_POST["animal_name"]));
        ...
        $stmtPart1 = 'INSERT INTO animals(animals.name, animals.animal_type, animals.mfi, animals.birthdate, animals.description';
        $stmtPart2 = ') VALUE ("'.$animal_name.'","'.$animal_type.'","'.$animal_mfi.'","'.$animal_birthdate.'","'.$animal_description.'"';

        if (!empty($_POST["animal_race"])) {
            $animal_race = htmlspecialchars(remove_emoji($_POST["animal_race"]));
            $stmtPart1 = $stmtPart1.', animals.animal_race';
            $stmtPart2 = $stmtPart2.',"'.$animal_race.'"';
        };
        if (!empty($_POST["animal_maison"])) {
            $animal_maison = htmlspecialchars(remove_emoji($_POST["animal_maison"]));
            $stmtPart1 = $stmtPart1.', animals.maison';
            $stmtPart2 = $stmtPart2.',"'.$animal_maison.'"';
        };
        if (!empty($_POST["animal_appartement"])) {
            $animal_appartement = htmlspecialchars(remove_emoji($_POST["animal_appartement"]));
            $stmtPart1 = $stmtPart1.', animals.appartement';
            $stmtPart2 = $stmtPart2.',"'.$animal_appartement.'"';
        };
        if (!empty($_POST["animal_enfants"])) {
            $animal_enfants = htmlspecialchars(remove_emoji($_POST["animal_enfants"]));
            $stmtPart1 = $stmtPart1.', animals.enfants';
            $stmtPart2 = $stmtPart2.',"'.$animal_enfants.'"';
        };
        if (!empty($_POST["animal_chiens"])) {
            $animal_chiens = htmlspecialchars(remove_emoji($_POST["animal_chiens"]));
            $stmtPart1 = $stmtPart1.', animals.chiens';
            $stmtPart2 = $stmtPart2.',"'.$animal_chiens.'"';
        };
        if (!empty($_POST["animal_chats"])) {
            $animal_chats = htmlspecialchars(remove_emoji($_POST["animal_chats"]));
            $stmtPart1 = $stmtPart1.', animals.chats';
            $stmtPart2 = $stmtPart2.',"'.$animal_chats.'"';
        };
        if (!empty($_POST["animal_categorie"])) {
            $animal_categorie = htmlspecialchars(remove_emoji($_POST["animal_categorie"]));
